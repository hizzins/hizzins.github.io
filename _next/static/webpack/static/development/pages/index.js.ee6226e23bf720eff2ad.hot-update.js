...
var car = function car(angle) {
  ...
  var r = wheelImage.imageWidth;
  var xPos = Math.cos(toRadian(angle)) * r;
  var yPos = Math.sin(toRadian(angle)) * r;
  console.log('여기', angle);
  carCtx.clearRect(0, 0, carCanvas.width, carCanvas.height);
  carCtx.beginPath();
  carCtx.arc(xPos + wheelImage.imageX + 45, yPos + wheelImage.imageX + 45, 50, 0, Math.PI, false);
...
//# sourceMappingURL=index.js.ee6226e23bf720eff2ad.hot-update.js.map