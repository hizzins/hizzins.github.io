...
var car = function car(angle) {
  ...
  var xPos = Math.cos(toRadian(angle)) * wheelImage.imageWidth;
  var yPos = Math.sin(toRadian(angle)) * wheelImage.imageHeight;
  console.log('여기', angle);
  carCtx.clearRect(0, 0, canvas.width, canvas.height);
  carCtx.beginPath();
  carCtx.arc(wheelImage.imageX, wheelImage.imageX + 40, 50, 0, Math.PI, false);
...
//# sourceMappingURL=index.js.225cd9e114b83aafd075.hot-update.js.map